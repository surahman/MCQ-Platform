...
type config struct {
	...
	} `json:"parent_level_1" yaml:"parent_level_1" mapstructure:"parent_level_1" validate:"required"`
	ParentLevel2 struct {
	...
	} `json:"parent_level_2" yaml:"parent_level_2" mapstructure:"parent_level_2" validate:"required"`
}
