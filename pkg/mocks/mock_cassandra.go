...
// Source: github.com/surahman/mcq-platform/pkg/data_store (interfaces: Cassandra)
...
import (
	...
	data_store "github.com/surahman/mcq-platform/pkg/data_store"
)
...
func (m *MockCassandra) Execute(arg0 func(data_store.Cassandra, interface{}) (interface{}, error), arg1 interface{}) (interface{}, error) {
	m.ctrl.T.Helper()
